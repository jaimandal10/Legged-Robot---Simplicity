...
int main(int argc, char** argv)
{
    ...
    // std::vector<std::string> joint_name = {"Rev14", "Rev18", "Rev35", "ankle_joint_lf", "shoe_joint_lf", 
    //                                        "Rev15", "Rev19", "Rev36", "ankle_joint_rf", "shoe_joint_rf",  
    //                                        "Rev16", "Rev20", "Rev37", "ankle_joint_lb", "shoe_joint_lb",
    //                                        "Rev17", "Rev21", "Rev38", "ankle_joint_rb", "shoe_joint_rb"};
    ...
    while(ros::ok())
    {
        ...
        joint_state.position[11] = -joint_state.position[11];
        ...
        joint_state.position[16] = -joint_state.position[16];
